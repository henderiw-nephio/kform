...
func dataSourceResourceBackendVLANClaim() *schema.Resource {
	defaultTimout := 5 * time.Minute
	return &schema.Resource{
		ReadContext: dataSourceResourceBackendVLANClaimRead,
...
func dataSourceResourceBackendVLANClaimRead(ctx context.Context, d *schema.ResourceObject, meta interface{}) ([]byte, diag.Diagnostics) {
